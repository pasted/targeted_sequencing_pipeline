class CalculateMetrics
	...
	def overall_metrics(sample, batch, logger)
			...
			input_file_string="#{batch.base_path}/#{batch.batch_id}/assembly/#{sample.panel_version.downcase}_#{sample.sample_id}_#{sample.gender.upcase}.realigned.bam"
			output_file_string="#{batch.base_path}/#{batch.batch_id}/metrics/#{sample.panel_version.downcase}_#{sample.sample_id}_#{sample.gender.upcase}.overall.bait_capture_metrics"
	...
	def phenotype_metrics(sample, batch, logger)
			...
			input_file_string		=	"#{batch.base_path}/#{batch.batch_id}/assembly/#{sample.panel_version.downcase}_#{sample.sample_id}_#{sample.gender.upcase}.realigned.bam"
			output_file_string	=	"#{batch.base_path}/#{batch.batch_id}/metrics/#{sample.panel_version.downcase}_#{sample.sample_id}_#{sample.gender.upcase}_#{sample.phenotype.upcase}.phenotype.bait_capture_metrics"
			this_panel = batch.select_panel(sample.panel_version.upcase)
	...
	def phenotype_coverage(sample, batch, logger)
			...
			input_file_string  = "#{batch.base_path}/#{batch.batch_id}/assembly/#{sample.panel_version.downcase}_#{sample.sample_id}_#{sample.gender.upcase}.realigned.bam"
			output_file_string = "#{batch.base_path}/#{batch.batch_id}/coverage/#{sample.panel_version.downcase}_#{sample.sample_id}_#{sample.gender.upcase}_#{sample.phenotype.upcase}.phenotype.by_base_coverage"
			this_panel = batch.select_panel(sample.panel_version.upcase)
	...
	def batch_phenotype_metrics(sample, batch, logger)
		batch_file_string = "#{batch.base_path}/#{batch.batch_id}/metrics/#{sample.panel_version.downcase}_#{sample.sample_id}_#{sample.gender.upcase}_#{sample.phenotype.upcase}.phenotype.bait_capture_metrics"

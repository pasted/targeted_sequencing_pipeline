class Metric
	...
	def variable_order
			...
			variable_order = variable_order + [:hs_library_size, :hs_penalty_10x, :hs_penalty_20x, :hs_penalty_30x, :hs_penalty_40x, :hs_penalty_50x, :hs_penalty_100x, :at_dropout, :gc_dropout, :sample_id, :library, :read_group]

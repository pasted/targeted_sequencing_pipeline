class AlamutAnnotation
	...
	def annotate(sample, batch, logger)
			...
			input_file_string = "../../variants/haplotyper/#{sample.panel_version}_#{sample.sample_id}_#{sample.gender.upcase}_#{sample.phenotype.upcase}.phenotype.hap_call.vcf"
			annotated_file_string = "../../variants/haplotyper/#{sample.panel_version}_#{sample.sample_id}_#{sample.gender.upcase}_#{sample.phenotype.upcase}.alamut.alltrans.txt"
			unannotated_file_string = "../../variants/haplotyper/#{sample.panel_version}_#{sample.sample_id}_#{sample.gender.upcase}_#{sample.phenotype.upcase}.alamut.alltrans.unannotated.txt"

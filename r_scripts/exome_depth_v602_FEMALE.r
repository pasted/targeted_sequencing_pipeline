...
bams.positive <- Sys.glob('v602*_FEMALE.realigned.bam')
bais.positive <- Sys.glob('v602*_FEMALE.realigned.bai')
...
#        pdf(paste('/mnt/Data4/targeted_sequencing/2015-08-11_1503151_rerun/cnv_analysis/v602/plots/',data$id,"_",out_plot_name, sep=''))

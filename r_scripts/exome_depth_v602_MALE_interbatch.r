...
dir.log <- sprintf("/mnt/Data4/working_directory/garan/pipeline_validation/%s/cnv_analysis/male/v602/logs/%s_male_%s.log", sequencing.run, sequencing.run, panel.version)

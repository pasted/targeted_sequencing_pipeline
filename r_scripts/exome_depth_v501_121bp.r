...
Alignment_folder <- '/mnt/Data4/targeted_sequencing/2015-06-04_1502221/assembly'
print(Alignment_folder)
setwd(Alignment_folder)
bed <- '/mnt/Data1/targeted_sequencing/intervals/v501/v501_CNV_121.bed'
reference.fasta <- '/mnt/Data1/resources/human_g1k_v37.fasta'

#get list of sample BAM files
bams.selected <- Sys.glob('v501_*_FEMALE_*.realigned.bam')
bais.selected <- Sys.glob('v501_*_FEMALE_*.realigned.bai')
...
dir.results <- NULL
	...
	dir.base <- "/mnt/Data4/targeted_sequencing/2015-06-04_1502221/cnv_analysis/CNVs/v501"
	save.image( sprintf("%s/exome_depth_count_v501_female.RData", dir.base) )

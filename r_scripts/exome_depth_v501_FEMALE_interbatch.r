...
dir.log <- sprintf("/mnt/Data4/working_directory/garan/pipeline_validation/%s/cnv_analysis/female/v501/logs/%s_female_%s.log", sequencing.run, sequencing.run, panel.version)

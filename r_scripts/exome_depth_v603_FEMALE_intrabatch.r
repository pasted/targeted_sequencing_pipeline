...
bams.selected <- Sys.glob('v603*_FEMALE.realigned.bam')
bais.selected <- Sys.glob('v603*_FEMALE.realigned.bai')
...
#	print(samplenames)
	dir.base <- "/mnt/Data4/targeted_sequencing/2016-07-04_2363/cnv_analysis/female/v603/results"
	save.image( sprintf("%s/exome_depth_count_v603_female.RData", dir.base) )

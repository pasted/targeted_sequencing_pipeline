...
dir.base <- sprintf("/mnt/Data4/working_directory/garan/pipeline_validation/%s/cnv_analysis/female/%s", sequencing.run, panel.version)
...
bams.female <- Sys.glob('v602*_FEMALE.realigned.bam')
bais.female <- Sys.glob('v602*_FEMALE.realigned.bai')
...
dir.log <- sprintf("/mnt/Data4/working_directory/garan/pipeline_validation/%s/cnv_analysis/female/v602/logs/%s_female_%s.log", sequencing.run, sequencing.run, panel.version)

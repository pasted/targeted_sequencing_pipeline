...
Alignment_folder <- '/mnt/Data4/targeted_sequencing/2015-06-12_1502339/assembly'
print(Alignment_folder)
setwd(Alignment_folder)
#bed <- args[2]
bed <- '/mnt/Data1/targeted_sequencing/intervals/v602/v602_CNV_121.bed'

#referenceFasta <- args[3]
reference.fasta <- '/mnt/Data1/resources/human_g1k_v37.fasta'

#get list of sample BAM files
bams.selected <- Sys.glob('v602_*_MALE_*.realigned.bam')
bais.selected <- Sys.glob('v602_*_MALE_*.realigned.bai')
...
#	print(samplenames)
	dir.base <- "/mnt/Data4/targeted_sequencing/2015-06-12_1502339/cnv_analysis/CNVs/v602"
	save.image( sprintf("%s/exome_depth_count_v602_male.RData", dir.base) )

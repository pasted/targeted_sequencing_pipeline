...
mkdir ../cnv_analyis/male/v501/results
mkdir ../cnv_analyis/male/v501/results/plots
mkdir ../cnv_analyis/male/v602
mkdir ../cnv_analyis/male/v602/results
mkdir ../cnv_analyis/male/v602/results/plots
mkdir ../coverage
mkdir ../duplicates
mkdir ../intervals
mkdir ../logs
